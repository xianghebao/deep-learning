...
/*
  练习1:
    ...
    return fp.prop('in_stock', last_car)//获取最后一个元素的in_stock属性
    }
...
/***
 * Practice 1 使用fp.flowRight重新实现上面的函数
 */
...
let isLastInStock = fp.flowRight(isInStock, last)
// 2.打印测试
...
let firstName = fp.flowRight(getCarName, first)
// 2.打印测试
...
let getDollarValue = car => fp.prop('dollar_value', car)
...
let sanitizeNames = fp.flowRight(_underscore, fp.map(fp.toLower))
// 2.打印测试
